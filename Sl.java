...
public class Sl implements ISl{  //класс, отвечающий за работу с файлами
	...
	public void getFile(){
		try{
		FileInputStream str = new FileInputStream("tbib.txt");
	...
	public String removeKey (String key){
		try{
			...
			if (count.length==2){
				...
				BufferedWriter BufW  = new BufferedWriter(new FileWriter("tbib.txt", true));
					searchKey(key);
					new FileWriter("tbib.txt").close();
	...
	public String addKey(String key, String value){
		try {
			...
			BufferedWriter BufW  = new BufferedWriter(new FileWriter("tbib.txt", true));//добавляем запись в конец файла
